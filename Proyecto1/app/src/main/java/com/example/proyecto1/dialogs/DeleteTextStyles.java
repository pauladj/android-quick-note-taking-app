...
public class DeleteTextStyles extends DialogFragment {

    ListenerDelDialogo miListener;

    public interface ListenerDelDialogo {
        void yesDeleteTextStyles();
    }
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        String deleteNote_title = getResources().getString(R.string.deleteStyles_title);
        builder.setTitle(deleteNote_title);
        String deleteNote_body = getResources().getString(R.string.deleteStyles_body);
        ...
        builder.setPositiveButton(positiveButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                miListener.yesDeleteTextStyles();
            }
        });
